<div id="rfqlistsec" style="display: none;">
    <!------------Rfq List Sec------------->
        ...
        <div class="col-md-12 col-sm-8">
            <div class="card mb-4 mt-2 tablecard">
                <div class="card-header pt-3">
                    <div class="row">
                      ...
                      <div class="col-md-6 d-flex justify-content-end">
                        <b>Total Records : <span><?php echo $rfq_count ?></span></b>
                      </div>
                    </div>  
                </div>
                ...
                <div class="card-body pt-1">
                    ...
                    <?php if (isset($resData) && $resData != "" && isset($resData['data']) && count($resData['data']) > 0) { ?>

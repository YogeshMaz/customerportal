                  ...
                  <div class="col-xl-6 col-md-6 mb-2">
                    <div class="card shadow h-100 border-top border-4 border-primary">
                      <div class="card-body bg-light">
                        <div class="row no-gutters align-items-center">
                          <div class="col p-1">
                            <div class="text-xs fw-bold text-uppercase mb-2 text-secondary">Units Delivered</div>
                            <div class="h5 mb-0 mr-3 fw-bold text-dark">
                              <?php if (isset($summaryDetails['data'][0]['Units_in_delivered_EA']) && $summaryDetails['data'][0]['Units_in_delivered_EA'] != 0) { ?>
                                <span class="pd_br1"><?php echo $summaryDetails['data'][0]['Units_in_delivered_EA'] ?? "-" ?> <small class="fs12"><?php echo "EA" ?></small></span>
                              <?php
                              }
                              if (isset($summaryDetails['data'][0]['Units_in_delivered_KG']) && $summaryDetails['data'][0]['Units_in_delivered_KG'] != 0) {
                              ?>
                                <span class="pd_br1 pd_lft1"><?php echo $summaryDetails['data'][0]['Units_in_delivered_KG'] ?? "-" ?> <small class="fs12"><?php echo "kg" ?></small></span>
                              <?php
                              }
                              if (isset($summaryDetails['data'][0]['Units_in_delivered_MTS']) && $summaryDetails['data'][0]['Units_in_delivered_MTS'] != 0) {
                              ?>
                                <span class="pd_lft1"><?php echo $summaryDetails['data'][0]['Units_in_delivered_MTS'] ?? "-" ?> <small class="fs12"><?php echo "Mts" ?></small></span>
                              <?php
                              }
                              ?>
                            </div>

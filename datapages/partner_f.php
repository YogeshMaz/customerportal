              ...
              <div class="col-md-12 col-sm-8">
                <div class="card mb-4 mt-2 tablecard">
                  ...
                  <div class="card-header pt-3 d-flex justify-content-between">
                      ...
                      <b>Total Records : <span><?php echo $partner_f_res_count ?></span></b>   
                  </div>

                  <div class="card-body pt-1">

                      <div class="table table-responsive">
                      <?php if (isset($partner_f_res_data['data']) && count($partner_f_res_data['data']) > 0){ ?>
                            ...
                            <tbody>
                                        ...
                                        <?php foreach ($partner_f_res_data['data'] as $record){ ?>
                                            <tr>
                                                ...
                                                <td><?php //echo htmlspecialchars($record['Project_Details'] ?? "-"); ?></td>
                                                ...
                                                <td><?php //echo htmlspecialchars($record['Search_for_MM_PO'] ?? "-"); ?></td>
                                            </tr>
                                        <?php } ?>
                                      </tbody>
                                    </table>
